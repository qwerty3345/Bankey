...
enum CurrencyFormatter {
    ...
    static func makeAttributedCurrency(_ amount: Decimal) -> NSMutableAttributedString {
    ...
    static func breakIntoDollarsAndCents(_ amount: Decimal) -> (String, String) {
        // ✨TIP: modf - Double 값의 정수부분, 소수부분을 tuple 형태로 나누어서 반환함
    ...
    private static func convertDollar(_ dollarPart: Double) -> String {
    ...
    // Convert 0.23 > 23
    private static func convertCents(_ centPart: Double) -> String {
        let cents: String
        if centPart == 0 {
            cents = "00"
        } else {
    ...
    static func dollarsFormatted(_ dollars: Double) -> String {
        let formatter = NumberFormatter()
    ...
    private static func makeBalanceAttributed(dollars: String, cents: String) -> NSMutableAttributedString {
